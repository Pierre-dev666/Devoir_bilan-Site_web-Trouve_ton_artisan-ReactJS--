...
function Footer() {
    ...
    <div id='tel'>Téléphone: <a href="tel:+33426734000">+33(0)426734000</a></div>
            ...
            <nav className="flex gap-4" id='footer_second-part'>
                               <Link to="/ListOfCraftsman" ><button>Mentions légales</button></Link>
                <Link to="/ListOfCraftsman" ><button>Données personnelles</button></Link>
                <Link to="/ListOfCraftsman" ><button>Accessibilité</button></Link>
                <Link to="/ListOfCraftsman" ><button>Cookies</button></Link>
            </nav>
        </header>
    )
}
